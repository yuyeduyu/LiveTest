...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig tagLogDaoConfig;
    ...
    private final TagLogDao tagLogDao;
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        tagLogDaoConfig = daoConfigMap.get(TagLogDao.class).clone();
        tagLogDaoConfig.initIdentityScope(type);
        ...
        tagLogDao = new TagLogDao(tagLogDaoConfig, this);
        ...
        registerDao(TagLog.class, tagLogDao);
    ...
    public void clear() {
        ...
        tagLogDaoConfig.getIdentityScope().clear();
