...
/** 
 * DAO for table "TAG_LOG".
*/
public class TagLogDao extends AbstractDao<TagLog, Long> {

    public static final String TABLENAME = "TAG_LOG";

    /**
     * Properties of entity TagLog.<br/>
    ...
    */
    ...
    public TagLogDao(DaoConfig config) {
        super(config);
    }
    
    public TagLogDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TAG_LOG\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TAG_LOG\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, TagLog entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TagLog entity) {
        stmt.clearBindings();
    ...
    @Override
    public TagLog readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, TagLog entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(TagLog entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(TagLog entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
