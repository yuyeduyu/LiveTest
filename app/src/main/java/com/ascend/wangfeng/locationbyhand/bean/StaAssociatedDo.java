...
public class StaAssociatedDo {
    /**
     * total : 3
     * rows_sta : [{"mac":"F4:29:81:4A:89:44","apmac":"8C:AB:8E:AF:A8:E8","essid":"ASCEND10","channel":6,"num":3,"signal":-78,"ltime":"23:15:45"}]
    ...
    public ApVo getRowsAp() {
        return rowsAp;
    }

    public void setRowsAp(ApVo rowsAp) {
        this.rowsAp = rowsAp;
    }
